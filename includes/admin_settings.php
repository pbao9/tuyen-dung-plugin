...
function wp2023_settings_field_render($args)
{
    ...
    switch ($type) {
        case 'text':
            ...
            ?>
            <input type="text" name="wp2023_settings_options[<?= esc_attr($args['label_for']); ?>]" value="<?= $value; ?>">
            <?php
            break;
        case 'password':
            $value = isset($options[$args['label_for']]) ? esc_attr($options[$args['label_for']]) : '';
            ?>
            <input type="password" name="wp2023_settings_options[<?= esc_attr($args['label_for']); ?>]" value="<?= $value; ?>">
            <?php
            break;
    }
}
